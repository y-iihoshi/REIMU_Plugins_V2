...
namespace ReimuPlugins.Th128Replay
{
    ...
    public static class Plugin
    {
        ...
        {
            private static readonly string ValidSignature = "128r".ToCP932();

            private static readonly string[] PluginInfoImpl =
            {
                "REIMU Plug-in For 妖精大戦争 Ver2.00 (C) IIHOSHI Yoshinori, 2015\0".ToCP932(),
                "妖精大戦争\0".ToCP932(),
                "th128_*.rpy\0".ToCP932(),
                "妖精大戦争 リプレイファイル (th128_*.rpy)\0".ToCP932(),
            };
            ...
            private static readonly Dictionary<ColumnKey, Func<ReplayData, string>> FileInfoGetters =
                new Dictionary<ColumnKey, Func<ReplayData, string>>
                {
                    ...
                    { ColumnKey.Route,    (data) => data.Route    },
                ...
                try
                {
                    ...
                    if (size == 0u)
                    {
                        ...
                        number = ThReplayData.GetNumberFromPath(
                            path, @"^th128_(\d{2})\.rpy$", @"^th128_ud(.{0,4})\.rpy$");
                    }
