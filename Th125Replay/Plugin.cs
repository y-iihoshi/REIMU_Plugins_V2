...
namespace ReimuPlugins.Th125Replay
{
    ...
    public static class Plugin
    {
        ...
        {
            private static readonly string ValidSignature = "t125".ToCP932();

            private static readonly string[] PluginInfoImpl =
            {
                "REIMU Plug-in For ダブルスポイラー Ver2.00 (C) IIHOSHI Yoshinori, 2015\0".ToCP932(),
                "ダブルスポイラー\0".ToCP932(),
                "th125_*.rpy\0".ToCP932(),
                "ダブルスポイラー リプレイファイル (th125_*.rpy)\0".ToCP932(),
            };
            ...
            private static readonly Dictionary<ColumnKey, Func<ReplayData, string>> FileInfoGetters =
                new Dictionary<ColumnKey, Func<ReplayData, string>>
                {
                    ...
                    { ColumnKey.Scene,     (data) => data.Scene    },
                ...
                try
                {
                    ...
                    if (size == 0u)
                    {
                        ...
                        number = ThReplayData.GetNumberFromPath(
                            path, @"^th125_(\d{2})\.rpy$", @"^th125_ud(.{0,4})\.rpy$");
                    }
