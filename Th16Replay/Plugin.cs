...
namespace ReimuPlugins.Th16Replay
{
    ...
    public static class Plugin
    {
        ...
        {
            private static readonly string ValidSignature = "t16r".ToCP932();

            private static readonly string[] PluginInfoImpl =
            {
                "REIMU Plug-in For 東方天空璋 Ver2.00 (C) IIHOSHI Yoshinori, 2017\0".ToCP932(),
                "東方天空璋\0".ToCP932(),
                "th16_*.rpy\0".ToCP932(),
                "東方天空璋 リプレイファイル (th16_*.rpy)\0".ToCP932(),
            };
