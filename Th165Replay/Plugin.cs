...
namespace ReimuPlugins.Th165Replay
{
    ...
    public static class Plugin
    {
        ...
        {
            private const string ValidSignature = "t156";

            private static readonly string[] PluginInfoImpl =
            {
                "REIMU Plug-in For 秘封ナイトメアダイアリー Ver2.00 (C) IIHOSHI Yoshinori, 2019\0",
                "秘封ナイトメアダイアリー\0",
                "th165_*.rpy\0",
...
#pragma warning disable SA1025 // Code should not contain multiple whitespace in a row
                    ...
                    { ColumnKey.Weekday,  (data) => data.Weekday  },
                    { ColumnKey.Dream,    (data) => data.Scene    },
                ...
                try
                {
                    ...
                    if (size == 0u)
                    {
                        ...
                        number = ThReplayData.GetNumberFromPath(
                            path, @"^th165_(\d{2})\.rpy$", @"^th165_ud(.{0,4})\.rpy$");
                    }
