...
namespace ReimuPlugins.Th15Replay
{
    ...
    public static class Plugin
    {
        ...
        {
            private static readonly string ValidSignature = "t15r".ToCP932();

            private static readonly string[] PluginInfoImpl =
            {
                "REIMU Plug-in For 東方紺珠伝 Ver2.00 (C) IIHOSHI Yoshinori, 2017\0".ToCP932(),
                "東方紺珠伝\0".ToCP932(),
                "th15_*.rpy\0".ToCP932(),
                "東方紺珠伝 リプレイファイル (th15_*.rpy)\0".ToCP932(),
            };
                ...
                try
                {
                    ...
                    if (size == 0u)
                    {
                        ...
                        number = ThReplayData.GetNumberFromPath(
                            path, @"^th15_(\d{2})\.rpy$", @"^th15_ud(.{0,4})\.rpy$");
                    }
